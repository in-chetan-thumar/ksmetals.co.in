...
<section class="banner">
    <figcaption>
        <h2 class="wow fadeInUp" data-wow-delay="0.2s"><span>Mining</span> a Strong<br> Future for Our Land</h2>
    </figcaption>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-10 col-xl-10 col-lg-11">
                    <div class="row">
                        <div class="col-xxl-3 col-lg-3 col-md-2">

                        </div>
                        <div class="col-xxl-9 col-lg-9 col-md-10">
                            <div class="about_cnt">
    ...
    <section class="mission_vission pt0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-11">
                    <div class="mv_row">
                        <div class="row g-4 align-items-center">
                            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 text-center">
                                <div class="mv_img wow fadeInRight" data-wow-delay="0.2s">
                                    <div class="rotate_img">
                                        <img src="{{asset('assets/frontend/images/mv_img1.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
                                <div class="mv_cnt">
                                    <h2 class="wow fadeInLeft" data-wow-delay="0.2s">Vision</h2>
                                    <p class="wow fadeInLeft" data-wow-delay="0.4s">Our vision is powered by the
                                        determination to lay a stronger foundation for the country’s growth. We see
                                        ourselves executing our concrete plans for the future by establishing a wash sand
                                        plant, a brick manufacturing unit, a ready mix concrete plant and 12 acres-wide teak
                                        plantations.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mv_row">
                        <div class="row g-4 align-items-center">
                            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 text-center">
                                <div class="mv_img wow fadeInLeft" data-wow-delay="0.2s">
                                    <div class="rotate_img">
                                        <img src="{{asset('assets/frontend/images/mv_img2.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
                                <div class="mv_cnt">
                                    <h2 class="wow fadeInRight" data-wow-delay="0.2s">Mission</h2>
                                    <p class="wow fadeInRight" data-wow-delay="0.4s">We began our journey with quality
                                        products, service, timely supply and diligent professionalism. Our mission is to
                                        live up to the mark we have set for ourselves as we continue to offer premium VSI
                                        metals from our 77 acres of mine land.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="products" class="products pt0">
        <div class="container">
    ...
    <section id="sustainability" class="sustainability pb0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-12 col-xl-12">
                    <div class="sustainability_sub">
                        <div class="row g-4">
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12">
                                <div class="sustainability_cnt">
                                    <div class="title_1 text-left wow fadeInRight" data-wow-delay="0.2s">
                                        <div class="title_main">Sustainability</div>
                                    </div>
                                    <p class="wow fadeInRight" data-wow-delay="0.4s">As a business that is driven by the
                                        commitment to scale up the country's landscape while contributing to the
                                        environment, we ensure that our business practices uphold the same values. To
                                        support that, we inculcate 100% use of solar power into our work and preserve
                                        rainwater to supply it to nearby villages free of cost for farming. Moreover, we
                                        facilitate the development of plantations with over 750 saplings sowed to date. Our
                                        premises also boast of an organic vegetables and fruits garden, complemented by
                                        plans of establishing a teak plantation and golf course in the coming time.</p>
                                </div>
                            </div>
                            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-12">
                                <div class="sustainability_img wow fadeInLeft" data-wow-delay="0.2s">
                                    <img src="{{asset('assets/frontend/images/sustainability_img.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="title_1">
                ...
                <div class="main_arrow">
                    ...
                    <div class="swiper-button-next-blog swiper-button-next"><svg width="9" height="15"
                            viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
...
@section('script')
    <script>
        var review_swiper = new Swiper('.blog-container', {
            autoplay: 2000,
            speed: 1000,
            autoplay: {
                delay: 2000,
